...
public class kXMLParseException extends RuntimeException {
	 ...
	 * 
	 * @param tag
	 *            The name of the tag where the error is located.
	 * @param message
	 *            A message describing what went wrong.
	 */
	public kXMLParseException(String tag, String message) {
		super("XML Parse Exception during parsing of " + ((tag == null) ? "the XML definition" : ("a " + tag + "-tag")) + ": " + message);
		this.lineNr = -1;
	}
	 ...
	 *            A message describing what went wrong.
	 */
	public kXMLParseException(String tag, int lineNr, String message) {
		super("XML Parse Exception during parsing of " + ((tag == null) ? "the XML definition" : ("a " + tag + "-tag")) + " at line " + lineNr + ": " + message);
		this.lineNr = lineNr;
	}
