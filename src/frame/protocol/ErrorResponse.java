...
/**
 * 错误回复包，�?��与服务器交互后的错误均在此汇总， 包括网络错误，服务器错误，协议错误以及未知错误等
 * 
 * @author zhouyin
 * 
 */
public class ErrorResponse implements BaseResponse {
	...
	// // public final static int ERROR_NULL_RESULT = 4; // 没有获取到任何结�?
	// public final static int ERROR_SERVER = 5; // 服务器内部错�?
	...
	// public final static int ERROR_INVALID_RESULT = 9; // 服务器无法获取有效结�?
	// public final static int ERROR_CLIENT_NET_DISCONNECTED = 10;// 本地网络不可�?
	// //////////////////////////////////////////////////////////////////////////////
	...
	public final static int ERROR_INVALID_RESULT = 922;// 服务正常，但返回结果不可�?
	...
	public final static int ERROR_SECURITY_UNKNOWN = 300;// 未知的安全认证错�?
...
//	群组不存�?427 密码错误-302 已经是群组成�?429 群组已满-440 无权�?303
